...
const SingleTodo: React.FC<Props> = ({ todo, todos, setTodos }) => {
    ...
    return (
        <form className="todos_single flex w-full lg:w-[95%] duration-200 hover:shadow-xl hover:scale-105 rounded-sm p-3 mt-4 bg-[url(https://img.freepik.com/free-photo/crumpled-yellow-paper-background-close-up_60487-2390.jpg?size=626&ext=jpg)]" onSubmit={(e) => handleEdit(e, todo.id)}>
